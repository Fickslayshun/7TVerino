export default {
	...
	badges: {
		subscriber: {
			tiered_months:
				"Tier {tier} for {months} Months | Tier {tier} for {months} Month | Tier {tier} for {months} Months",
	...
	emote_menu: {
		...
		favorite_emotes_hint_1: "You don't have any Favorite Emotes yet",
		favorite_emotes_hint_2: "Hold {HOTKEY} and click an emote to add it to your favorites",
	...
	onboarding: {
		...
		platforms_subtitle:
			"Select the platforms onto which you'd like to enable 7TV. We'll configure the extension's permissions for you.",
		...
		config_subtitle:
			"We'll ask you a few questions and recommend you some settings to get you started. You can change these later at any time.",
		...
		compat_subtitle: "Check your browser extensions for compatibility issues. This is optional.\n",
		...
		end_social_media1: "Follow us on X",
		end_social_media2: "Stay up to date on x.com",
	...
	site: {
		kick: {
			...
			connect_popup_done:
				"Your channel has been successfully connected to 7TV! Use the 7tv.app website to start adding emotes",
		},
	},
	settings: {
